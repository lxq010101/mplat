...
public class FullyLinearLayoutManager extends GridLayoutManager {
    ...
    public FullyLinearLayoutManager(RecyclerView view, int spanCount) {
        super(view.getContext(), spanCount);
        this.view = view;
        this.overScrollMode = ViewCompat.getOverScrollMode(view);
    }

    public FullyLinearLayoutManager(RecyclerView view, int spanCount, int orientation, boolean reverseLayout) {
